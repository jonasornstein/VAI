# pending/requirements — AIRUP Review

Draft **RUP requirements** artifacts before promotion to `docs/`.
...
**Status values:** `AWAITING_JONTE` | `AWAITING_OPERATOR` | `AWAITING_POVL` | `AWAITING_NISSE` | `APPROVED`

On **APPROVED**, merge into `docs/requirements/` or `docs/VISION.md` and log in [TRACE-LOG.md](../../docs/TRACE-LOG.md).