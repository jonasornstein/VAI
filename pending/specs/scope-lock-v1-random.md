...
- [ ] Scope lock **APPROVED** by Jonte
- [ ] Random generator produces valid 8-leg proposal from manual YAML
- [ ] Cost matches ATG formula for 3+ golden examples
- [ ] Fixed seed reproduces identical selections
- [ ] Budget cap enforced per UC-11
- [ ] Kricke or Jonte confirms proposal is transcribable to ATG UI
