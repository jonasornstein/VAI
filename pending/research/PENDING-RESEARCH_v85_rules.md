...
|---------|------------|-------------------|
| **8** | **30%** | If no one has 8 correct, or payout below threshold → jackpot (see §3.3) |
...
**Nisse:** Confirm against Swedish spelregler; EN translation should match.
...
**Nisse:** Confirm ST/ATG practice when disqualification changes winner after provisional result.
...
## 12. Open items for Nisse

| ID | Item | Priority |
|----|------|----------|
| OI-001 | Sign off against S-009a EN PDF + S-009b Swedish spelregler | Must |
| OI-001b | Confirm 2026-07-02 pool rules supersede PDF 35/15/15/35 | Must — **verified S-013/N-004; Nisse sign-off** |
| OI-002 | Disqualification — definitive result practice (§20 drafted) | Should |
| OI-003 | Dead heat §10 multiplier — draft per S-009a | Should |
| OI-004 | Spelstopp time after Sept 2026 schedule change | Should |
| OI-005 | Jackpot carry-over exact V85 wording | Should — partial via S-008/S-014; formal PDF TBD |
| OI-006 | Boost rules relevance for proposals | Could |
