...
| **Approved** | 2026-07-29 — ornstein (operator) |
| **Implements** | F-044–F-048; UC-12 extension (manage roster) |
| **Parent** | [expert-v1.md](./expert-v1.md) |
| **Review** | [REVIEW_expert-roster-manage-v1.md](../reviews/REVIEW_expert-roster-manage-v1.md) |
...
| Version | Date | Change |
|---------|------|--------|
| 0.4 | 2026-07-29 | **APPROVED** (ornstein); count `N synliga av M`; select/deselect all; ↑/↓ reorder; list `counts` |
