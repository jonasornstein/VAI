# Request — v1 scope: Random mode + manual YAML
...
Prior session established UX mockups, RUP requirements (UC-01–UC-31), and approved V85 rules + quantitative strategy docs. Generators in `src/` are scaffold-only.