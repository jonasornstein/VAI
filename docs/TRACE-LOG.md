...
| 2026-08-07 | P | Assistant | **Commit + push expert auto-slip + mode isolation** — `23cad2c` on `origin/master`; remove UPPDATERA SPELKVITTO; horse select/deselect recalcs slip; Hari/Expert independent state; **prod later live** with v1.3.1 | https://vai.ornstein.work/ ; mockup `outbox/mockups/v85-proposal-ux-mockup-atg.html` |
