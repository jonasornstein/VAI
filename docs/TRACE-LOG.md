...
|------|-------------|-------|---------|-----------------|
| 2026-07-31 | P | Assistant | **Commit + push + deploy activity stats** — `466c470` standalone `vai-stats.html` (sort/filter); nginx static `/vai-stats.html` + `/activity.jsonl`; not wired into Python app | https://vai.ornstein.work/vai-stats.html ; `vai-stats.html`; deploy/nginx-*.conf |
